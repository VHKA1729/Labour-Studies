...
library("jaccard")
library("lsr")
data_c= read.csv("Option1_HRM/security.csv",stringsAsFactors = FALSE)## last column doesnt have any value
# data_c=data_c[,!(names(data_c) %in% "Q31B_Pension")]
 data_c$Q29_Second_Job[data_c$Q29_Second_Job =="999.0"]<- "missing"
 data_c$Q30_SecondJob_MonthlyIncome[data_c$Q30_SecondJob_MonthlyIncome =="999.0"]<- "missing"
 data_c$Q31_Remittence_to_Home[data_c$Q31_Remittence_to_Home =="5.0"]<- "missing"
...
data_c1= read.csv("Option1_HRM/security.csv")#[,-c(1,3,61)]## 
...
##### Q3 vs Q21
table1=table(data_c1$Q3_Education,data_c1$Q25_LongTerm_CareerPlan)
fisher.test(table1)        # There is no association b/t education and long term career plan
#### Q3 vs Q23
table2=table(data_c1$Q3_Education,data_c1$Q27_Monthly_Income)
fisher.test(table2)        # there is no assocaition b/t monthly income and education
#### Q3 vs Q22
table3=table(data_c$Q3_Education,data_c$Q26_Investment_PersonalDevelopment)
...
##### Q1 vs Q21
table5=table(data_c1$Q1_Age,data_c1$Q25_LongTerm_CareerPlan)
...
table8 = table(encoded$`Q3_Education_Graudate/diploma`,encoded$`Q25_LongTerm_CareerPlan_Will switch to personal business`)
...
table9 = table(encoded$`Q1_Age_20-25`,encoded$`Q25_LongTerm_CareerPlan_Will switch to personal business`)
...
table10 = table(encoded$`Q1_Age_26-30`,encoded$`Q25_LongTerm_CareerPlan_Will switch to personal business`)
...
table4=table(encoded$`Q3_Education_Stand. 1-5`,data_c1$Q43A_JobPerception_FairTreatment)
fisher.test(table4) 


table5 = table(encoded$`Q3_Education_Stand. 1-5`,data_c1$Q42B_JobSatisfaction_Salary)
fisher.test(table5)
table5 = table(encoded$`Q3_Education_Stand. 6-9`,data_c1$Q42B_JobSatisfaction_Salary)
fisher.test(table5)

table5 = table(encoded$`Q3_Education_Graudate/diploma`,data_c1$Q42B_JobSatisfaction_Salary)
fisher.test(table5)
